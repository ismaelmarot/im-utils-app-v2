    ...
    return (
        ...
        <StyledModalBody>  
            ...
            <p>2. Propiedad intelectual:
                Salvo que se indique lo contrario, el contenido, diseño y código fuente de este sitio se distribuyen bajo la <SpanStyled>licencia MIT</SpanStyled>, lo que significa que puede usar, copiar, modificar y distribuir el código, siempre que se conserve la atribución correspondiente.  
                <SpanStyled> Nota: </SpanStyled>Algunos contenidos (como logotipos, imágenes o textos) pueden no estar cubiertos por esta licencia y siguen siendo propiedad exclusiva de Ismael Marot.
            </p>
            <p>3. Uso permitido:
            ...
            <p>Contacto: 
                Si tiene alguna duda sobre estos términos, consultas o inquietudes; escriba a <AStyled href='mailto:ismaelmarot@hotmail.com'>ismaelmarot@hotmail.com</AStyled>
            </p>
